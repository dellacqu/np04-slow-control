...
if ($type == 0) {
    ...
    $stid = oci_parse($conn, "select TS, VALUE_NUMBER from (select * from NP04_DCS_01.VEVENTSCREEN order by TS asc) where ELEMENT_NAME like '%".$elemId."%' and TS >= sysdate - ".$days);
}
oci_execute($stid);
