...
angular.module('crate', []).component('crate', {
    ...
    controller: function crateController($http, $q, $interval) {
        ...
        this.reload = function () {
            let temp0 = $http.get("php-db-conn/crate.conn.php?elemId=NP04_DCS_01:gizmo.RES");
            let temp1 = $http.get("php-db-conn/crate.conn.php?elemId=NP04_DCS_01:gizmo.TH");
            let temp2 = $http.get("php-db-conn/crate.conn.php?elemId=NP04_DCS_01:gizmo.mag");
            let temp3 = $http.get("php-db-conn/crate.conn.php?elemId=NP04_DCS_01:gizmo.I");
            let temp4 = $http.get("php-db-conn/crate.conn.php?elemId=NP04_DCS_01:gizmo.Q");
