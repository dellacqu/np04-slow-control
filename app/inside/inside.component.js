...
angular.module('inside', []).component('inside', {
    ...
    controller: function insideController($http, $q, $interval) {
        ...
        this.reload = function () {
            ...
            let temp3 = $http.get("php-db-conn/cryostat.conn.php?elemId=NP04_7TT0200AIR");
            let temp4 = $http.get("php-db-conn/cryostat.conn.php?elemId=NP04_7TT0201AIR");
            let temp5 = $http.get("php-db-conn/cryostat.conn.php?elemId=NP04_7TT0202AIR");
            let temp6 = $http.get("php-db-conn/cryostat.conn.php?elemId=NP04_7TT0206AIR");
            let temp7 = $http.get("php-db-conn/cryostat.conn.php?elemId=NP04_7TT0212AIR");
            let temp8 = $http.get("php-db-conn/cryostat.conn.php?elemId=NP04_7TT0214AIR");
            let temp9 = $http.get("php-db-conn/cryostat.conn.php?elemId=NP04_7TT0218AIR");
            let temp10 = $http.get("php-db-conn/cryostat.conn.php?elemId=NP04_7TT0219AIR");
